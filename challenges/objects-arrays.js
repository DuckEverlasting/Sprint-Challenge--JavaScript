...
console.log(dinoTyrannosaurus.roar());
...
*/
const populationArray = zooAnimals.map(element => {return element.population});
const populationTotal = populationArray.reduce((accum, num) => accum + num);
...
Stretch: If you haven't already, convert your array method callbacks into arrow functions. ALREADY DONE!
